...
import { Upload, AlertCircle, Check, Code, FileCode, Github, Twitter, Zap, Shield, Eye, Search, ArrowRight, Star, Cpu, Terminal } from 'lucide-react';
import './App.css';
  ...
  return (
    <div className="console-output">
      ...
      <div className="console-content">
        {logs.length === 0 ? (
          <div className="console-empty">No logs available yet. Upload and analyze a file to see detailed logs.</div>
        ) : (
          logs.map((log, index) => (
...
function App() {
  ...
  const handleFileChange = (event) => {
    if (event.target.files && event.target.files[0]) {
      ...
      setResult(null);
      setConsoleLogs([`Selected file: ${event.target.files[0].name} (${(event.target.files[0].size / 1024).toFixed(2)} KB)`]);
    }
  };
  ...
  const handleFileUpload = async () => {
    ...
    try {
      setLoading(true);
      setConsoleLogs(prev => [...prev, `Uploading file: ${file.name}`]);
      ...
      // Add detailed logs based on file type and analysis
      const fileExt = file.name.split('.').pop().toLowerCase();
      setConsoleLogs(prev => [
        ...prev, 
        `File type detected: ${fileExt}`,
        `Analysis complete. Processing results...`,
        `Found ${response.data.smells ? response.data.smells.length : 0} code smells.`
      ]);
      
      // Add detailed logs for each smell
      if (response.data.smells && response.data.smells.length > 0) {
        const smellTypes = {};
        response.data.smells.forEach(smell => {
          smellTypes[smell.type] = (smellTypes[smell.type] || 0) + 1;
          setConsoleLogs(prev => [...prev, `Detected: ${smell.type} - ${smell.details}`]);
        });
        ...
        setConsoleLogs(prev => [
          ...prev, 
          '--- Analysis Summary ---',
          ...Object.entries(smellTypes).map(([type, count]) => `${type}: ${count} occurrences`)
        ]);
      } else {
        setConsoleLogs(prev => [...prev, 'No code smells detected. Your code looks clean!']);
      }
      ...
      setConsoleLogs(prev => [...prev, `Error: ${error.message || 'Failed to process file'}`]);
      addToast({
        title: "Error",
              ...
              <div className="hero-container">
                ...
                >
                  ...
                  <p className="hero-subtitle">
                    Our advanced AI-powered tool detects code smells, anti-patterns, and potential bugs before they impact your production environment.
                  </p>
                  <motion.div 
                  ...
                  <div className="code-window">
                    ...
                    <div className="code-window-content">
                      <pre className="code-block">
                        <code>
                          <span className="code-keyword">function</span> <span className="code-function">analyzeCode</span>(code) {'{'}
                            ...
                            <span className="code-keyword">if</span> (hasLongMethods(code)) {'{'}
                              smells.push({'{'}
                                type: <span className="code-string">"Long Method"</span>,
                                details: <span className="code-string">"Method too long"</span>
                              {'}'});
                            {'}'}
                            
                            <span className="code-keyword">if</span> (hasDuplicateCode(code)) {'{'}
                              smells.push({'{'}
                                type: <span className="code-string">"Duplicate Code"</span>,
                                details: <span className="code-string">"Found similar patterns"</span>
                              {'}'});
                            {'}'}
              ...
              <div className="testimonials-container">
                <div className="testimonial-card">
                  <div className="testimonial-content">
                    <p>"This tool has completely transformed our code review process. We catch issues before they even reach the review stage now."</p>
                  </div>
                ...
                <div className="testimonial-card">
                  <div className="testimonial-content">
                    <p>"I've been able to improve my coding habits significantly thanks to the detailed feedback from CodeSniffer."</p>
                  </div>
                  <div className="testimonial-author">
                ...
                <div className="testimonial-card">
                  <div className="testimonial-content">
                    <p>"As a team lead, this tool has been invaluable for maintaining code quality standards across our projects."</p>
                  </div>
                  <div className="testimonial-author">
            ...
            <div className="footer-content">
              <div className="footer-main">
                <div className="footer-branding">
                  ...
                  <p className="footer-tagline">
                    Elevate your code quality with intelligent analysis
                  </p>
                </div>
              ...
              <div className="footer-bottom">
                <div className="footer-copyright">
                  © 2025 CodeSniffer. All rights reserved.
                </div>
                
                <div className="footer-social">
                  <motion.a 
                    href="https://github.com/Junaid059" 
                    target="_blank"
              ...
              <div className="analyzer-grid">
                              ...
                              {file ? (
                                ...
                                >
                                  ...
                                  <p className="upload-hint">
                                    Any code file (JS, TS, Java, Python, etc.)
                                  </p>
                                </motion.div>
                              )}
                            </AnimatePresence>
                                ...
                                {Array.isArray(result.smells) && result.smells.length > 0 ? (
                                  <div className="smell-list">
                                    {result.smells.map((smell, index) => (
                                      ...
                                      >
                                        <h3 className="smell-type">
                                          {smell.type}
                                        </h3>
                                        <p className="smell-details">
                                          {smell.details}
                                        </p>
                                      </motion.div>
                                    ))}
                ...
                <Card className="console-card">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Detailed logs and information from the code analysis process
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
          ...
          <footer className="app-footer">
            <div className="footer-content">
              ...
              <div className="footer-message">
                Improve your code quality with automated smell detection
              </div>
